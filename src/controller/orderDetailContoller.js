...
export const orderDetailController = {
    ...
    create:async(req,res,next)=>{
        ...
        const result = await dbConnection.query(query,[orderId,productId,quantity,unitPrice,totalPrice])
    ...
    update:async(req,res,next)=>{
        ...
        if(!body.orderId && !body.productId && !body.quantity && !body.unitPrice && !body.totalPrice) 
